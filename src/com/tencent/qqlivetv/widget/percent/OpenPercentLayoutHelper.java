 ...
 * @createTime:2016-12-21下午3:01:41
 * @version:4.2.4
 * @modifyTime:
 * @modifyAuthor:
 * @description:
...
public class OpenPercentLayoutHelper
{
    ...
    public OpenPercentLayoutHelper(ViewGroup host)
    {
        mHost = host;
        getScreenSize();
    }
     ...
     * {@link OpenPercentLayoutHelper#adjustChildren(int, int)}.
     */
